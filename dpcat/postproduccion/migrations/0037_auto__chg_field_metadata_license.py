...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Metadata.license'
        db.alter_column('postproduccion_metadata', 'license', self.gf('django.db.models.fields.CharField')(max_length=2))
    
    
    def backwards(self, orm):
        
        # Changing field 'Metadata.license'
        db.alter_column('postproduccion_metadata', 'license', self.gf('django.db.models.fields.CharField')(max_length=255))
