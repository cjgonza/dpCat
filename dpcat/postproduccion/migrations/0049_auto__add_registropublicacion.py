...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('postproduccion_registropublicacion', (
        ...
        db.send_create_signal('postproduccion', ['RegistroPublicacion'])


    def backwards(self, orm):
        
        # Deleting model 'RegistroPublicacion'
        db.delete_table('postproduccion_registropublicacion')
