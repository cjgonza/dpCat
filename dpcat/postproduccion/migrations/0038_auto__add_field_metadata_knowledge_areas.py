...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Metadata.knowledge_areas'
        db.add_column('postproduccion_metadata', 'knowledge_areas', self.gf('django.db.models.fields.CharField')(default='  ', max_length=2), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Metadata.knowledge_areas'
        db.delete_column('postproduccion_metadata', 'knowledge_areas')
