...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MetadataOA.title'
        db.alter_column('postproduccion_metadataoa', 'title', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'MetadataGen.title'
        db.alter_column('postproduccion_metadatagen', 'title', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Video.titulo'
        db.alter_column('postproduccion_video', 'titulo', self.gf('django.db.models.fields.CharField')(max_length=100))


    def backwards(self, orm):
        
        # Changing field 'MetadataOA.title'
        db.alter_column('postproduccion_metadataoa', 'title', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'MetadataGen.title'
        db.alter_column('postproduccion_metadatagen', 'title', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Video.titulo'
        db.alter_column('postproduccion_video', 'titulo', self.gf('django.db.models.fields.CharField')(max_length=255))
    ...
    models = {
        ...
        'postproduccion.informeproduccion': {
            ...
            'aprobacion': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        'postproduccion.metadatagen': {
            ...
            'language': ('django.db.models.fields.CharField', [], {'default': "u'Espa\\xf1ol'", 'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'license': ('django.db.models.fields.CharField', [], {'max_length': '2'}),
            'location': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'venue': ('django.db.models.fields.CharField', [], {'default': "u'San Crist\\xf3bal de La Laguna, Tenerife (Espa\\xf1a)'", 'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'video': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['postproduccion.Video']", 'unique': 'True'})
        },
