...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'IncidenciaProduccion.emisor'
        db.add_column('postproduccion_incidenciaproduccion', 'emisor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'IncidenciaProduccion.emisor'
        db.delete_column('postproduccion_incidenciaproduccion', 'emisor_id')
    ...
    models = {
        ...
        'postproduccion.incidenciaproduccion': {
            ...
            'emisor_tmp': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
