...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'IncidenciaProduccion.emisor_tmp'
        db.add_column('postproduccion_incidenciaproduccion', 'emisor_tmp', self.gf('django.db.models.fields.CharField')(default='', max_length=1), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'IncidenciaProduccion.emisor_tmp'
        db.delete_column('postproduccion_incidenciaproduccion', 'emisor_tmp')
