...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'MetadataGen'
        db.create_table('postproduccion_metadatagen', (
            ...
            ('venue', self.gf('django.db.models.fields.CharField')(default=u'San Crist\xf3bal de La Laguna, Tenerife (Espa\xf1a)', max_length=255, null=True)),
            ('language', self.gf('django.db.models.fields.CharField')(default=u'Espa\xf1ol', max_length=255, null=True)),
            ...
            ('contributor', self.gf('django.db.models.fields.CharField')(max_length=255, null=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('postproduccion', ['MetadataGen'])

        # Adding field 'Video.objecto_aprendizaje'
        db.add_column('postproduccion_video', 'objecto_aprendizaje', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting model 'MetadataGen'
        db.delete_table('postproduccion_metadatagen')

        # Deleting field 'Video.objecto_aprendizaje'
        db.delete_column('postproduccion_video', 'objecto_aprendizaje')
    ...
    models = {
        ...
        'postproduccion.metadatagen': {
            'Meta': {'object_name': 'MetadataGen'},
            'contributor': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True'}),
            ...
            'language': ('django.db.models.fields.CharField', [], {'default': "u'Espa\\xf1ol'", 'max_length': '255', 'null': 'True'}),
            ...
            'venue': ('django.db.models.fields.CharField', [], {'default': "u'San Crist\\xf3bal de La Laguna, Tenerife (Espa\\xf1a)'", 'max_length': '255', 'null': 'True'}),
            'video': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['postproduccion.Video']", 'unique': 'True'})
        },
        ...
        'postproduccion.video': {
            ...
            'fichero': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'objecto_aprendizaje': ('django.db.models.fields.BooleanField', [], {'default': 'True', 'blank': 'True'}),
